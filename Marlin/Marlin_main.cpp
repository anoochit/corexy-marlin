...
#include "buzzer.h"
  ...
  Adafruit_NeoPixel ext_neopixel = Adafruit_NeoPixel(60, 42, NEO_GRB + NEO_KHZ800);
  Adafruit_NeoPixel bed_neopixel = Adafruit_NeoPixel(60, 44, NEO_GRB + NEO_KHZ800);
#endif
...
void setup() {
  ...
  //colorWipe(ext_neopixel.Color(127, 127, 127), 1);
  //ext_neopixel.show();
  #endif
 ...
 //  SET Bed LED 
  ...
  //  SET Extruder LED   
    ...
    if(ext_c != last_ext_c) {
      ...
      colorWipe(ext_neopixel.Color(neo_r, neo_g, neo_b), 1);
      //ext_neopixel.show();
    }
  }
}
